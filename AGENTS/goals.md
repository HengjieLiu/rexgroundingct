...
# Goals And Open Decisions

## Current Goals

- Keep a reproducible VoxTell baseline for ReXGroundingCT.
- Preserve clear provenance between repo configs, runtime snapshots, and synced
  metrics.
