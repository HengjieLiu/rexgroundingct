...
# VoxTell ReX fine-tuning rescue ablation
...
- Execution spec: `experiments/003_voxtell_rex_ft_rescue_ablation/codex_execution_spec.md`
- Runtime directory: `/mnt/shengdata1/hengjie/experiments/rexgroundingct/003_voxtell_rex_ft_rescue_ablation`
