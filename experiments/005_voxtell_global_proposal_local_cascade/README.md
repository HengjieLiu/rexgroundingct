...
# VoxTell global proposal to local segmentation cascade
...
- Canonical config: `configs/experiments/005_voxtell_global_proposal_local_cascade.json`
- Execution spec: `experiments/005_voxtell_global_proposal_local_cascade/codex_execution_spec.md`
- Runtime directory: `/mnt/shengdata1/hengjie/experiments/rexgroundingct/005_voxtell_global_proposal_local_cascade`
- Runtime link: `runtime` is ignored by git and points to the runtime directory.

## Synced Small Artifacts

- Report snapshot: `experiments/005_voxtell_global_proposal_local_cascade/report.md`
