...
# VoxTell dual-branch proposal/refinement ablation
...
- Canonical config: `configs/experiments/008_voxtell_dual_branch_proposal_refinement_ablation.json`
- Execution spec: `experiments/008_voxtell_dual_branch_proposal_refinement_ablation/codex_execution_spec.md`
- Runtime directory: `/mnt/shengdata1/hengjie/experiments/rexgroundingct/008_voxtell_dual_branch_proposal_refinement_ablation`
- Runtime link: `runtime` is ignored by git and points to the runtime directory.

## Synced Small Artifacts

- Report snapshot: `experiments/008_voxtell_dual_branch_proposal_refinement_ablation/report.md`
