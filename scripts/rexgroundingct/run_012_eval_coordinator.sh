...
arm_dataset() {
  case "$EVAL_ARM:$EVAL_SCOPE" in
    category_1alldiffuse_replay50:target)
      echo /workspace/configs/evaluation/rexgroundingct_val42_category_1alldiffuse_target_census.json ;;
    category_1alldiffuse_replay50:union)
      echo /workspace/configs/evaluation/rexgroundingct_val80_category_1alldiffuse_milestone_union.json ;;
    category_2a_replay50:target)
      echo /workspace/configs/evaluation/rexgroundingct_val63_category_2a_target_census.json ;;
    category_2a_replay50:union)
      echo /workspace/configs/evaluation/rexgroundingct_val114_category_2a_milestone_union.json ;;
    category_2b_replay50:target)
      echo /workspace/configs/evaluation/rexgroundingct_val40_category_2b_target_census.json ;;
    category_2b_replay50:union)
      echo /workspace/configs/evaluation/rexgroundingct_val98_category_2b_milestone_union.json ;;
    category_2c_replay50:target)
      echo /workspace/configs/evaluation/rexgroundingct_val53_category_2c_target_census.json ;;
    category_2c_replay50:union)
      echo /workspace/configs/evaluation/rexgroundingct_val110_category_2c_milestone_union.json ;;
...
(
  ...
  EVAL_LOCK_HELD=1 GLOBAL_ONLY=1 EVAL_DATASET_JSON_OVERRIDE="$dataset" \
    EVAL_LABEL="Experiment 012 $EVAL_ARM epoch $EVAL_EPOCH $EVAL_SCOPE threshold 0.5" \
